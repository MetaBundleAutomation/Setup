...
Write-ColorText ""
Write-ColorText "4. Alternatively, run with Docker:" -ForegroundColor "White"
Write-ColorText "   cd '$scriptPath'" -ForegroundColor "Yellow"
Write-ColorText "   .\run-docker.ps1" -ForegroundColor "Yellow"
Write-ColorText ""
